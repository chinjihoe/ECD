...
public class LoginActivity extends AppCompatActivity{
    ...
    private void buttonListeners(){
        ...
        final Button debugButton = (Button) findViewById(R.id.debugButton); //Deze button skipt het login process om te kunnen werken aan de rest
    ...
    //Vraag informatie van gebruiker op na inloggen
